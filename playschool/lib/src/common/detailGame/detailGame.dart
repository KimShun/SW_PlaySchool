                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Swiper(
                          autoplay: true,
                          scale: 0.8,
                          itemCount: gameData.detailImagePath.length,
                          pagination: SwiperPagination(
                            builder: DotSwiperPaginationBuilder(
                              activeColor: gameData.gameType == GameType.play
                                ? PLAY_HEADER_COLOR : gameData.gameType == GameType.ent
                                ? EXERCISE_HEADER_COLOR : MAKE_HEADER_COLOR,
                                  ...
                                  Expanded(
                                    child: SizedBox.expand(
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(gameData.detailImagePath[index],
                                          fit: BoxFit.cover,
                                        )
                                      ),
                                    ),
              ...
              child: ElevatedButton(
                onPressed: () {
                  final Map<String, String> gameRouteMap = {
                    "그림 그리기": "/drawingGame",
                    "단어그림맞추기": "/word_matching",
                    "틀린그림찾기": "/findWrongPlay",
                    "율동 따라하기": "/selectDance",
